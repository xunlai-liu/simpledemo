...
public class JsonUtils {
    ...
    public static <T> List<T> gsonToList(String json, Class<T> cls) {
        List<T> list = null;
        if (gson != null) {
            list = gson.fromJson(json, new com.google.common.reflect.TypeToken<List<T>>() {
            }.getType());
        }
        return list;
    }
    ...
    public static <T> List<Map<String, T>> gsonToListMaps(String json) {
        ...
        if (gson != null) {
            list = gson.fromJson(json, new com.google.common.reflect.TypeToken<List<Map<String, T>>>() {
            }.getType());
        }
        return list;
    }
